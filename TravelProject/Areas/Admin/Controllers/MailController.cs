...
namespace TravelProject.Areas.Admin.Controllers
{
	...
	public class MailController : Controller
	{
		...
		public MailController(IContactUsService contactUsService)
		{
		...
		[HttpGet]
		public IActionResult SendMailToContactUs(int id)
		{
			var user = _contactUsService.GetById(id);
			ViewBag.userMail = user.ContactUsMail;
			return View();
		}

		[HttpPost]
		public IActionResult SendMailToContactUs(MailRequest mailRequest)
		{
			try
			{
